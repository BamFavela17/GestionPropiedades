...
?>
    ...
    <section class="seccion contenedor">
        ...
        <div class="alinear-derecha">
            <a href="/src/pages/anuncios.php" class="boton-verde">Ver Todas</a>
        </div>
    </section>
    ...
    <section class="imagen-contacto">
        ...
        <a href="/src/pages/contacto.php" class="boton-amarillo">Contactános</a>
    </section>
